...
const Navbar = () => {
  ...
  //NOTE - for tokens generations(meaning fetch and store , also refresh for it ..if not found)
  ...
  //NOTE - keep the localStorage token in sync with clerk auth state
...
//NOTE - after successful login redirect us to dashboard
useEffect(() => {
  if(isSignedIn){
...
//     (async() => {
//       if(isSignedIn){
//         const t = await fetchAndStoreToke({template: "default"}).catch(
//           () => null
//         )
//         if(!t && mounted){
//           await fetchAndStoreToke({forceRefresh: true}).catch(()=> null)
//         }
//       }
//       else{
//         try {
    ...
    <header className={navbarStyles.header}>
        ...
        <nav className={navbarStyles.nav}>
          <div className={navbarStyles.logoSection}>
            <Link to="/" className={navbarStyles.logoLink}>
              ...
              <span className={navbarStyles.logoText}>Invoo</span>
            </Link>
      ...
      <div className={`${open ? "block" : "hidden"} ${navbarStyles.mobileMenu}`}>
          <div className={navbarStyles.mobileMenuContainer}>
            ...
            <a href="#docs" className={navbarStyles.mobileNavLink}>
              Docs
            </a>
