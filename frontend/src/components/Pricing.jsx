      ...
      <div className={pricingStyles.container}>
        <div className={pricingStyles.headerContainer}>
          <div className={pricingStyles.badge}>
            ...
            <span className={pricingStyles.badgeText}>Pricing</span>
          </div>

          <h2 className={pricingStyles.title}>
            Simple,{" "}
            <span className={pricingStyles.titleGradient}>Genius Pricing</span>
          </h2>

          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias
            perferendis aut saepe illo explicabo
          </p>
          ...
          >
            ...
            >
              Annual
              <span className={pricingStyles.billingBadge}>Save 10%</span>
            </button>
          </div>
        </div>
        ...
        <div className={pricingStyles.additionalInfo}>
          <div className={pricingStyles.featuresCard}>
            <h3 className={pricingStyles.featuresTitle}>All Plans includes</h3>
